...
- [mpv `--vo=gpu` composites black under GLES](./core/gles-mpv-shm-black.md) — medium: found gathering evidence for the formats change, present before it; pixman draws the same client correctly.
